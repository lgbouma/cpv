...
therefore generally discard the ``spot-only'' scenario.
...
The river plots are slightly more processed:
a maximum-likelihood two-harmonic sinusoid has been independently fitted and
subtracted from the Sector 18-19 data, 25-26 data, and 53, 58, and 59
data in order to accentuate any changes in the dip timing and structure.
