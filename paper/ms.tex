...
of these two B stars appear surprisingly similar to the CR light
curves \citep{2020pase.conf...46M}.  The middle row of
Figure~\ref{fig:bstar} shows the phased TESS light curves for these
two stars, with by-eye best-matching CRs shown underneath for
...
%
    \item The shortest CR dips, also with durations of
      ...
      the star.
%
    \item Many CR dips have durations a few times longer than $T_{\rm
...
%
    \item Surprising analogs to the CRs exist in two magnetic B stars,
      ...
      fields \citep{2009ARA&A..47..333D}, this suggests that the CR
