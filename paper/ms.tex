...
\begin{itemize}
	%
  \item CQVs are quasiperiodic.  While the mean periods in our
  ...
  \item The CQV phenomenon persists for at least 150\,Myr, based on
    ...
    in the Hyades and Praesepe suggests that the phenomenon does become
    less common at older ages.
	%
...
\begin{figure*}[!t]
	...
	\caption{
		...
		7 sectors of continuous 2-minute observations.  (Thanks to DDT029)
	}
	\label{fig:lpriver0}
\end{figure*}
