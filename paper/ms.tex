...
\begin{abstract}
  ...
  smooth, spot-like modulation.  Based on a lack of observed infrared
  excesses, these objects do not have primordial gas-rich disks.
...
\begin{figure*}[!t]
	\begin{center}
    \centering
    \includegraphics[width=\textwidth]{402980664_S0018_120sec_cpvvetter.pdf}
		\vspace{-0.45cm}
		\caption{
