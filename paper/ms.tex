...
\begin{abstract}
  ...
  million years (Myr) old, and they do not have primordial gas-rich
  ...
  collected between July~2018 and Sep~2022.  Our search used two
  methods, the first based on counting dips in phase-folded light
  curves, and the second based on counting peaks in the Fourier
  ...
  and closest examples of this class of object known ($T$$\approx$11;
  $d$$\approx$20\,pc).  A few objects are outliers among outliers; LP
  12-502 for instance shows four to eight local minima per cycle
  distributed over a ``dip complex'' with a total duration that is
  nearly constant over more than 1000 cycles.  Nonetheless, LP-502 at
  times also showed drastic shape changes over less than one cycle.
  More generally, we find that none of the CQVs maintain a fixed light
  curve shape over timescales of more than a few hundred cycles --
  they are {\it quasi}periodic.  Although the physical explanation
  behind these objects remains enigmatic, our sample may help clarify
  their origin.  Connections to star, disk, and exoplanet evolution
  are emphasized.
\end{abstract}
...
cadence for every sector during which it was on silicon.
...
Ah, and the flux changes by 3.5\% over about 22 minutes (0.02\,$P$),
which is the steepest slope exhibited anywhere in this object's
remarkable dataset.
During the beginning of Sector~26 (Cycles 283-298), there are seven
clear dips per cycle.
The the second orbit of this sector,
...
\begin{figure*}[!t]
    ...
    \includegraphics[width=0.9\textwidth]{TIC_402980664_P18.5604_2min_phase_timegroups_mosaic.pdf}
		...
		\caption{
			{\it Bottom:}
      Evolution of LP 12-502 ($P$=18.5604\,h) at fixed period and
