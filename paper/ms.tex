...
% 250 word max!
\begin{abstract}
  We explore a set of pre-main-sequence stars
  with sub-solar masses, rotation periods of 0.2--2 days, optical variability amplitudes
  of a few percent, and sharp light curve features that repeat for
  hundreds of rotation cycles.  The sharp features are probably caused by
  eclipsing clumps of dust or gas orbiting at the corotation radius.
  We refer to this class of star as ``complex periodic variables'' (CPVs).
  To improve our understanding of these
  enigmatic objects, we conducted a survey for CPVs using TESS
  short-cadence data collected between 2018~July and 2022~September.
  Our search of \nstarssearched\ K and M dwarfs with $T$$<$16 and
  $d$$<$150\,pc yielded \ngoods\ high-quality CPVs, most of which are
  new discoveries.  Our sample includes the brightest
  ($T$$\approx$9.5), closest ($d$$\approx$20\,pc), and oldest
  ($\approx$200\,Myr) known CPVs.  One of the new discoveries, LP
  12-502, stands out for the complexity of its light curve --- with as
  many as eight flux dips per cycle --- and for the detail with which 
  each dip's evolving amplitude and phase can be tracked over
  1{,}500 cycles.  We argue that corotating gas or dust remains the
  most viable explanation for CPVs. The gas or dust is probably
  entrained by the star's magnetic field, and the sharp features could
  result from a multipolar field topology, a hypothesis supported by
  correspondences between the light curves of CPVs and of B stars
  known to have multipolar magnetic fields.
\end{abstract}
