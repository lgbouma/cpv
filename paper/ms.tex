...
% 250 word max!
\begin{abstract}
  We study a set of sub-solar mass pre-main-sequence stars
...
matter is dragged along with the field lines.  
The tendency of both gas and dust to
become trapped at corotation is then tied to how of the four relevant
...
$R_{\rm c}$ \citep[e.g.][their Section~2]{2005MNRAS.357..251T}.  Another way to
...
\begin{figure}[!t]
	\begin{center}
		\centering
		\includegraphics[width=0.46\textwidth]{f2completeness.pdf}
		\vspace{-0.2cm}
		\caption{
...
not see any such instances of dips switching on.  Dip growth seems to happen more slowly.  For instance, the dip at phase 0-0.1
...
JNW significantly improved the clarity of the manuscript.
