...
eclipsing binaries, such as TIC~193831684 or TIC~5714469.  We 
believe these cases are unlikely to be eclipsing binaries
due to the additional coherent peaks and troughs in the light curves,
which are
distinct from any binary phenomena of which we are aware.
...
pre-main-sequence stars in the solar neighborhood.  However, given the
$\lesssim$$10\%$ completeness of TESS beyond 100\,pc, there are
probably many more CQVs in Sco-Cen that remain to be discovered.  
...
associate either star with any young groups.  Both do seem to
show the CQV signal over multiple TESS sectors, and both are
photometrically elevated relative to the main sequence.  
Both were also noted by \citet{2021ApJ...917...23K} as being in the
...
(Figure~\ref{fig:lpriver0}) reveal multiple distinct periodicities in the
...
variability would probably drive one toward a picture of a
