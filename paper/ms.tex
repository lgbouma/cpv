...
\begin{abstract}
  ...
  have lifetimes of $\approx$100 cycles, and the dips collapse in
  response to stellar flares once every few months.  Corotating
...
We present the detailed results concerning binarity in
...
The closest newly-recognized CPV in our catalog is DG~CVn (TIC~368129164),
...
observational nuisances and curiosities.  The
nuisances include
astrophysical false positives with two beating rapidly
rotating stars, as well as uncertainty about which
star is producing the CPV signal in binary systems.  Our two candidate K dwarf CPVs 
suffer from the latter concern (see Section~\ref{subsec:resultsbinarity}).
...
For instance, recent work has shown that the orbits of binaries closer than
