...
\begin{abstract}
  ...
  periodic optical light curves.  Previous work has shown that such
  stars tend to be disk-free pre-main-sequence M dwarfs with rotation
  periods of 0.2--2 days.  To advance understanding of these enigmatic
  objects, we performed a blind CPV search using TESS 2-minute data of
  ...
  age-dating.  One exceptional new object, LP 12-502, showed up to
  eight dips per cycle; the dips at times coexisted with slightly
  different periods, and the variability of the dips suggests that
  they are additive and independent.  Broadly, our search confirms
  ...
  response to stellar flares once every few months.  Corotating gas or
  dust clumps remain the only viable explanation.  The gas or dust is
  ...
  B stars known to have multipolar magnetic fields.
  %
\end{abstract}
...
\begin{figure*}[!t]
	\begin{center}
		...
		\subfloat{
			\includegraphics[width=0.48\textwidth]{f9d.pdf}
