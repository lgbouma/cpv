...
\citep{2017AJ....153..152S,2022AJ....163..144G}.  TIC~405754448 and TIC~405910546 however
...
lowest amplitude dips.  While TIC~405754448 might be an unresolved
binary (RUWE$_{\rm DR3}$=4.7),  the depth of the coherent dips present
in the Sector~11 light curve imply that the CQV signal is indeed from
...
which M dwarfs remain rapid rotators over the first 700\,Myr
\citep[e.g. Figure~13 of][]{2022AJ....164...80R}, it seems surprising
...
local minima, and one ``hump'' \citep{2005ApJ...630L..81T, 2022ApJ...924L..10J}.  
Within the model proposed by Townsend et al., this is explained by the simplicity of 
the star's magnetic field, which to first-order is a
...
sinusoidal envelope, all seem to be quite similar.  The
implication of such a surprising connection would be that the
...
within 150\,pc.  The selection function was $\gtrsim 80\%$ complete within 30\,pc,
and $\lesssim 10\%$ complete at distances exceeding 100\,pc.
...
%TODO: nix this paragraph?  This edge on hypothesis only holds
%TODO if the magnetic field is aligned with the stellar spin axis.
{\bf todo: nix paragraph? technically this only works if B is aligned
with stellar spin axis... which would be aligned w planetary system}
