...
\begin{abstract}
  ...
  period and total duration that are fixed over more than 1000 cycles,
  ...
  corotating dust clumps are the most likely explanation.  In the
  ...
  evolution.  For instance, based on the rate of dip evolution, we
...
$\approx$$10^7$ years timescale typically quoted for the primordial
disk to disperse (CITE).  However, unambiguous evidence, for instance
a spectroscopic detection of silicates during a ``dip'', has yet to be
acquired.
...
two years apart.
Such a baseline was available for 32 of the \ngoods\ CQVs in our
catalog; for plotted purposes we show the brightest 27.
Of these 27 CQVs,
a few show clear signs of the phenomenon in one sector,
and marginal or non-existence signs in the other.
While there is some subjectivity in this assessment, to our eye
cases for which at least one sector would be flagged as ``ambiguous'' include
TIC~368129164 (S23 might be labelled an EB),
TIC~193831684 (which has been erroneously labelled an EB CITE Albrecht paper),
TIC~177309964 (S38 would be simply a rotating star),
TIC~404144841 (S38 looks like a rotating star),
TIC~201898222 (S3 looks like a rotating star),
TIC~144486786 (S32 might be flagged as a possible RS CVn),
TIC~38820496 (S28 might be a possible RS CVn).
