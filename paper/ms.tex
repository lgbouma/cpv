...
\begin{abstract}
  ...
  CPVs and of B stars known to have multipolar magnetic fields.
  %
\end{abstract}
...
the same criterion.  Of the \ngoodhighruwe\ good CPVs with ${\rm
RUWE}_{\rm DR3}> 2$, \ngoodruweandmultperiod\ also showed secondary
periods in the TESS light curves.  Considering the weaker threshold of
${\rm RUWE}_{\rm DR3}> 1.4$,
...
Both of the stars with IR exceses are in the TW Hydrae association
...
\begin{figure*}[!t]
	\begin{center}
      ...
      ambiguous CPV candidates are light blue circles.  Unresolved
...
%
    \item The CPV peaks and dips evolve over timescales that are both secular
      ...
      collapsing instantaneously, and
      occur once every few months for
      both LP~12-502 and TIC~300651846.
      They are almost always linked with
...
Comparing the 20-second to 2-minute data for these stars (data
