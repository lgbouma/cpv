...
probably many more CQVs that remain to be discovered in Sco-Cen.  
...
\ncpvsfound\ star sample, we labeled two objects as having ``good''
...
One challenge is perhaps that in systems like LP 12-502, the observed
dip depth variations would necessarily drive one toward a picture of a
disintegrating planetesimal swarm, rather than just a single
planetesimal.  The need for more than just one launching body would be
driven by the observation that we see dips appear and disappear at
...
There are at least three problems with this concept of a
disintegrating planetesimal swarm.  First, the model would predict
