...
\begin{abstract}
  ...
  discovered in TESS short-cadence data collected between July~2018 and Sep~2022.
  ...
  examples of this class of object known, and perhaps also the most massive
  ($\approx$0.6-0.8\,M$_\odot$).  A few objects are outliers among
  ...
  periods simultaneously, and showed drastic shape changes shortly
  ...
  the broader contexts of star, disk, and exoplanet evolution.
  For instance, if the transiting material is dust, then the rate of dip
  evolution implies that of order an asteroid belt's worth of mass
  passes through these structures over their lifetime of $\approx$$10^8$ years.
\end{abstract}
...
The upper age limit for the CQV phenomenon may even reach 200\,Myr,
based on the candidate membership of TIC~294328885 in the Carina Near
moving group \citep{2006ApJ...649L.115Z}.  This group's age primarily
rests on the lithium sequence of its G-dwarfs
\citep{2006ApJ...649L.115Z}, which shows a coeval population
of stars older than the Pleiades and younger than the 400\,Myr Ursa
Major moving group.  It would interesting to improve the
precision of the group's age measurement, for instance using
gyrochronology of F, G or K members, in order to verify this point.
...
\begin{figure*}[!t]
	\begin{center}
      ...
      The lower-left panel compares the rotation--color distribution of the CQVs, and candidate CQVs, against the rotation
      periods of K- and M-dwarfs in the Pleiades from \citet{2016AJ....152..114R}.
      Note the scale change for the period $P$ from days to hours in the middle panel of the lower row.
		}
...
\begin{enumerate}[leftmargin=*]
  ...
  \item The CQV phenomenon persists for $\gtrsim$150\,Myr, based on
    ...
    moving group (TIC~294328885; $\approx$200\,Myr).  The lack of
