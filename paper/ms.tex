...
For CPVs, binarity seems to mostly provide a mix of
nuisances and curiosities.  The
nuisances include
...
of an intermediate-separation binary could cause early disk dispersal,
...
CPV sample ($\approx$32\% from RUWE$_{\rm DR3}$) seems approximately
...
Figures~\ref{fig:evoln} and~\ref{fig:lpriver0}).  Although we refer
to them as ``periodic'', the CPVs are
therefore actually quasiperiodic, with quality factors of $Q$$\approx$100.
