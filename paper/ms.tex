...
\begin{abstract}
  ...
  collected between July~2018 and Sep~2022. 
%  Our search used two
...
%  domain. 
  ...
  12-502 for instance shows a ``dip complex'' with a total duration that is
  nearly constant over more than 1000 cycles, 
  but exhibits anywhere from four to eight local minima per cycle.  
  LP-502 also at
  times showed drastic shape changes over less than one cycle.
  ...
  their origin.  In particular, we highlight the plausibility of a disintegrating
  planetesimal swarm model.
  Connections to star, disk, and exoplanet evolution are emphasized.
\end{abstract}
...
\begin{figure*}[!t]
	\begin{center}
		\subfloat{
			...
			\includegraphics[width=0.43\textwidth]{TIC402980664_river_gist_stern_248_315_manual_20230617_mask_v0_nterms2_vmin-0.04000_vmax0.01000.png}
		}
	\vspace{0.4cm}
			\subfloat{
		\includegraphics[width=0.43\textwidth]{TIC402980664_river_gist_stern_1411_1481_manual_20230617_mask_v0_nterms2_vmin-0.04000_vmax0.01000.png}
				\includegraphics[width=0.43\textwidth]{TIC402980664_river_gist_stern_1233_1265_manual_20230617_mask_v0_nterms2_vmin-0.04000_vmax0.01000.png}
	}
	\end{center}
	\caption{
    {\bf River plots of LP 12-502}, showing (clockwise from top-left) Sectors 18-19, 25-26, 53, and 58-59.
    A two-harmonic
    sinusoid has been subtracted over specific chunks in time ({\bf see text}).
	}
	\label{fig:lpriver0}
