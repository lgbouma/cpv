...
\begin{figure*}[!t]
    ...
    {\it Top:} Phase-folded TESS light curves of three CRs.  Each
...
\begin{figure}[!tp]
	\begin{center}
      ...
      radial shells, each with a width of 10\,pc.  To be counted, these stars must meet
      the listed conditions: they must
      be red ($\bprp$>$1.5$)
      dwarf stars ($M_{\rm G}$>4) amenable for TESS observations ($T$<16).
      The blue solid curve shows the
      fraction of such stars with at least one sector of TESS
      2-minute cadence data acquired between Sectors 1-55.  The
      latter data comprise the selection function for our complex
      rotator search.
		}
			\vspace{-0.5cm}
