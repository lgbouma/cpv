...
\begin{abstract}
  ...
  many as eight flux dips per cycle --- and for the detail with which the
...
acronym for ``complex rotator'' is already widely used in the astrophysical
...
clumps of gas or dust orbit at the corotation radius.
